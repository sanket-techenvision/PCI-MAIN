...
<body>
    <div class="container">
        ...
        <p>Address: <span style="color: red;">{{ $beneficiary_address }}</span></p>
        ...
        <p>Address: <span style="color: red;">{{ $applicant_address }}</span></p>
        ...
        <p>WE, <span style="color: red;">{{ $bank_name }}, {{ $bank_address }}</span>, AT THE REQUEST OF OUR CLIENT <span style="color: red;">{{ $applicant_first_name }} {{ $applicant_last_name }}, {{ $applicant_address }},</span></p>
        <p>HEREBY CONFIRM WITH FULL FINANCIAL RESPONSIBILITY THAT WE ARE READY WILLING AND ABLE TO ISSUE A <span style="color: red;">{{ $letter_type }}</span> REFERENCE TO CONTRACT NO. <span style="color: red;">[CONTRACT NO]</span> DATED [DATE] WITH FACE VALUE <span style="color: red;">{{ $guarantee_amount }}</span> IN FAVOUR OF <span style="color: red;">{{ $beneficiary_first_name }} {{ $beneficiary_last_name }} {{ $beneficiary_address }}</span> IN YOUR GOOD BANK, AND IT SHALL BE TRANSMITTED BY SWIFT MT760.</p>
