...
<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <input class="form-control @error('beneficiary_company_name') is-invalid @enderror" type="text" id="beneficiary_company_name" name="beneficiary_company_name" placeholder="Enter Beneficiary Company Name" value="{{ old('beneficiary_company_name') }}" required>
